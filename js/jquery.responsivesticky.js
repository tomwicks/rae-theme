(function ( $ ) {
  ...
  function sticky(stickyDiv) {
    ...
    var stickyMarginTop = 50;                       
    jQuery(stickyDiv).css({'top': stickyMarginTop, 'position': 'fixed', 'left': jQuery(stickyDiv).offset().left});
  ...
  function stickyReset(stickyDiv) {
    ...
    jQuery(stickyDiv).css({'top': 0, 'left': 0, 'position': 'relative'});
