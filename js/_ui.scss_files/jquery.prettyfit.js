(function ( $ ) {
  ...
  $.fn.prettyfit = function (options) {
    ...
    return this.each(function() {
      ...
      bgPosition = topElHeight + 100; 
      bgScreenshotPosition = bgPosition + 81;

      $(this).height(totalElHeight);

      $(this).find(settings.bgEl).css('background-position', 'center ' + bgPosition + 'px, center ' + bgScreenshotPosition + 'px');
